...
exports.handler = async function(event) {
  ...
  try {
    ...
    if (!authDate || now - authDate > 86400) {
      return { statusCode: 403, body: JSON.stringify({ error: 'Auth data is too old' }) };
    }

    return { statusCode: 200, body: JSON.stringify({ ok:true, user: {
      id: fields.id, username: fields.username || '', first_name: fields.first_name || '',
      last_name: fields.last_name || '', photo_url: fields.photo_url || ''
    }})};
  } catch (e) {
